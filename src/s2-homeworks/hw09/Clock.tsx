...
function Clock() {
    ...
    const getDate = (date:number) => date < 10 ? `0${date}` : date

    const stringTime = `${getDate(date.getHours())}:${getDate(date.getMinutes())}:${ getDate(date.getSeconds())}` || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
